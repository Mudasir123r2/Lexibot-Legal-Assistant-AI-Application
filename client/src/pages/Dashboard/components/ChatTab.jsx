...
import { FiSend, FiLoader, FiTrash2, FiMessageSquare, FiChevronLeft, FiChevronRight, FiMic, FiMicOff, FiThumbsUp, FiThumbsDown } from "react-icons/fi";
              ...
              <div className="space-y-1 max-h-[calc(100%-80px)] overflow-y-auto">
                {sessions.map((session) => (
                  <div
                    ...
                    className={`group px-2 py-2 rounded-lg cursor-pointer flex items-start gap-2 transition-colors ${
